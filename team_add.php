<?php
    ...
    if ($_SESSION['access_user'] != 'Administrator') {
        ...
        if(isset($_POST['btn_teamadd'])){
            ...
            if($fulfillment1 != $fulfillment2){
                $query=mysqli_query($con,"insert into teams(name_team, fulfillment1, fulfillment2, quantity_team, id_patner) 
                values('$name_team','$fulfillment1','$fulfillment2','$quantity_team','$id_patner')"); 
            }

            if($query){
                echo "<script>alert('User added successfully.');</script>";   
                echo "<script>window.location.href='team_add.php'</script>";
            } else{
                                    ...
                                    <form class="needs-validation" method="post" novalidate>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03" name="name_team" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-2 mb-10">
                                                ...
                                                <input type="number" class="form-control" id="validationCustom03" name="quantity_team" required>
                                            ...
                                            <div class="col-md-2 mb-10">
                                                <label for="validationCustom03">Patner</label>
                                                    <select class="form-control custom-select" name="id_patner" required>
                                                        <option value="">select one</option>
                                                        <?php
                                                        $querypat=mysqli_query($con,"select * from patner");
                                        ...
                                        <button class="btn btn-primary" type="submit" name="btn_teamadd">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </section>
